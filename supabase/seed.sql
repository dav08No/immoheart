...
insert into anfragen (id, firma_id, flaeche_min, flaeche_max, ort, budget_pro_m2, bezug, nutzung, anforderungen, status, letzter_kontakt) values
  ('33333333-3333-3333-3333-333333333301', '11111111-1111-1111-1111-111111111101', 320, 450, 'Bettlach', 165, 'Q1 2027', 'produktion', '{}', 'offen', now() - interval '1 day'),
  ('33333333-3333-3333-3333-333333333302', '11111111-1111-1111-1111-111111111102', 1800, 2600, 'Wasseramt', 130, 'Q2 2027', 'produktion', '{}', 'offen', now() - interval '3 days'),
  ('33333333-3333-3333-3333-333333333303', '11111111-1111-1111-1111-111111111103', 180, 260, 'Solothurn', 250, 'Q4 2026', 'buero', '{}', 'offen', now() - interval '12 days'),
  ('33333333-3333-3333-3333-333333333304', '11111111-1111-1111-1111-111111111104', 200, 300, 'Solothurn', 210, 'Q1 2027', 'gewerbe', '{}', 'offen', now() - interval '15 days'),
  ('33333333-3333-3333-3333-333333333305', '11111111-1111-1111-1111-111111111105', 1500, 2500, 'Solothurn', 110, 'Q1 2027', 'lager', '{}', 'offen', now() - interval '22 days'),
  ('33333333-3333-3333-3333-333333333306', '11111111-1111-1111-1111-111111111106', 2000, 3000, 'Solothurn', 118, 'sofort', 'lager', '{"rampe": true}', 'offen', now() - interval '41 days'),
  ('33333333-3333-3333-3333-333333333307', '11111111-1111-1111-1111-111111111107', 1900, 2400, 'Bucheggberg', null, null, 'gewerbe', '{}', 'offen', now() - interval '63 days'),
  ('33333333-3333-3333-3333-333333333308', '11111111-1111-1111-1111-111111111108', 2200, null, 'Zuchwil', 125, 'Q4 2026', 'produktion', '{"kran_tonnen": 16}', 'offen', now() - interval '96 days');
